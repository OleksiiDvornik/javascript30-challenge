...
const birthdateSort = inventors.sort((a, b) => a.year > b.year ? 1 : -1);
...
const alphabetSort = people.sort((lastOne, nextOne) => {
...
const trasports = data.reduce((object, item) => {
    if (!object[item]) {
        object[item] = 0;
    } 
    object[item]++
